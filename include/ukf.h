...
class UKF {
public:
    pcl::PointCloud<pcl::PointXYZ> dimensions;
...
//    std::ofstream NISvals_laser_rm_;
    ...
    void Initialize(VectorXd z, double timestamp, pcl::PointCloud<pcl::PointXYZ> dimension);
     ...
     */
    void MeasurementPrediction(int modelInd);
